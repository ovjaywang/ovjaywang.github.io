...
$$ \left\{\begin{matrix}\frac{f}{\overline{Z}}dXs+\frac{x}{\overline{Z}}dZs-(f+\frac{x^{2}}{f})d\varphi-\frac{xy}{f}d\omega+yd\kappa -\frac{f}{\overline{Z}}dX-\frac{x}{\overline{Z}}dZ+\frac{x}{f}df+dx\_{0}-(x-x\_{cal})=0\\\\ \frac{f}{\overline{Z}}dYs+\frac{y}{\overline{Z}}dZs -\frac{xy}{f}d\varphi-(f+\frac{x^{2}}{f})d\omega-xd\kappa -\frac{f}{\overline{Z}}dX-\frac{y}{\overline{Z}}dZ+\frac{y}{f}df+dy\_{0}-(y-y\_{cal})=0\end{matrix}\right.$$

 上式即称为<font color="#FF0000">线性化的共线方程</font>。

$$\left\{\begin{matrix}\frac{f}{\overline{Z}}dXs+\frac{x}{\overline{Z}}dZs-(f+\frac{x^{2}}{f})d\varphi-\frac{xy}{f}d\omega+yd\kappa -\frac{f}{\overline{Z}}dX-\frac{x}{\overline{Z}}dZ+\frac{x}{f}df+dx\_{0}-(x-x\_{cal})=v\_{x}\\\\\frac{f}{\overline{Z}}dYs+\frac{y}{\overline{Z}}dZs -\frac{xy}{f}d\varphi-(f+\frac{x^{2}}{f})d\omega-xd\kappa -\frac{f}{\overline{Z}}dX-\frac{y}{\overline{Z}}dZ+\frac{y}{f}df+dy\_{0}-(y-y\_{cal})=v\_{y}\end{matrix}\right.$$
...
$$\left\{\begin{matrix}x\_{res}=x-x\_{cal}+x\_{dis}\\y\_{res}=y-y\_{cal}+y\_{dis}\end{matrix}\right.$$

其中，右边三项分别为像点观测坐标，像点计算坐标，畸变误差。
 在后方交会时，当只计算外方位元素时：

 $$V_{2n\times 1}=A\_{2n\times6}X\_{6\times1}-L\_{2n\times1}$$.
...
$$N^{-1}=\begin{bmatrix}Q\_{11}&Q\_{12}&.&.&.&Q\_{1t}\\Q\_{21}&Q\_{22}&.&.&.&Q\_{2t}\\.&.&&.&&.\\.&.&&.&&.\\.&.&&.&&.\\Q\_{t1}&Q\_{t2}&.&.&.&Q\_{tt}\end{bmatrix}$$,则<font color="#FF0000">**第i个未知数中的误差**</font>为:
